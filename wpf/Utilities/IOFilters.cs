...
namespace hsb.WPF.Utilities
{
    ...
    public static class IOFilters
    {
        ...
        {
            return direction.IsOutput() ? s : s.ToUpper();
        }
        #endregion
        ...
        {
            return direction.IsOutput() ? s : s.ToLower();
        }
        #endregion
        ...
        {
            return direction.IsOutput() ? s : s.Trim();
        }
        #endregion
        ...
        {
            return direction.IsOutput() ? s : s.TrimStart();
        }
        #endregion
        ...
        {
            return direction.IsOutput() ? s : s.TrimEnd();
        }
        #endregion

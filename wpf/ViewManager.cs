...
namespace hsb.WPF
{
    ...
    public class ViewManager
    {
        ...
        #region - ViewModel2View : VeiewとViewModelとの紐づけを管理するための辞書
        /// <summary>
        /// VeiewとViewModelとの紐づけを管理するための辞書
        /// </summary>
        private Dictionary<Type, Type> ViewModel2View { get; set; }
        #endregion
        ...
        #region - Add : ViewModelとViewの関連を追加する(1)
        /// <summary>
        ...
        #region - Add : ViewModelとViewの関連を追加する(2)
        /// <summary>
        /// ViewModelとViewの関連を追加する(2)
        /// </summary>
        /// <param name="vm2v">IEnumerable of ViewModel and View Pair : ViewModelとViewのペアの列挙</param>
        ...
        #region - CreateView : 指定したViewModelに対応するViewを生成する
        /// <summary>
        ...
        #region - GetView : 既に存在するWindowのコレクションから、指定したViewModelに対応するWindowを返す。
        /// <summary>
        ...
        #region - ShowModalView : ViewModelから対応するViewをモーダルで表示する
        /// <summary>
        ...
        #region - ShowView : ViewModelから対応するViewをモードレスで表示する
        /// <summary>
